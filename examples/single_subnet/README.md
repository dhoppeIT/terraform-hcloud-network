...
This example will manage the Hetzner Cloud network and creates a single subnet.

## Graph

<img alt="Graph" src="https://github.com/dhoppeIT/terraform-hcloud-network/blob/main/examples/single_subnet/rover.svg?raw=true" width="100%" height="100%">
